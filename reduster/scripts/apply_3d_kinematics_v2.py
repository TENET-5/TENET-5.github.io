...
function spawnEnemy(type = 'grunt') {
  const stats = {
    grunt:  { hp: 100, speed: 7.5, damage: 15, score: 10, ranged: false, scale: 1.0 },
    heavy:  { hp: 300, speed: 4.5, damage: 25, score: 30, ranged: false, scale: 1.2 },
    ranger: { hp: 80,  speed: 6.6, damage: 10, score: 20, ranged: true,  scale: 0.9 }
  };
