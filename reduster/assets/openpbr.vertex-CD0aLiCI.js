import{v as e}from"./index-B4NgycvP.js";import"./sceneVertexDeclaration-BRSQjMjI.js";import"./openpbrUboDeclaration-DF-QEaR2.js";const n="openpbrVertexDeclaration",t=`#include<sceneVertexDeclaration>
#ifdef BASE_COLOR
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=t);const o="openpbrNormalMapVertexDeclaration",E=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ)
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=_);const i="openpbrVertexShader",a=`#define OPENPBR_VERTEX_SHADER
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=a);const A={name:i,shader:a};export{A as openpbrVertexShader};
