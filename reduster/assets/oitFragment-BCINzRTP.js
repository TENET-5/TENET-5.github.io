import{S as e}from"./index-CuKS0v27.js";const t="prePassDeclaration",m=`#ifdef PREPASS
...
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=x);const o="clusteredLightingFunctions",w=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=w);const f="shadowsFragmentFunctions",L=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=L);const s="samplerFragmentDeclaration",T=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=T);const n="reflectionFunction",X=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=X);const d="bumpFragmentMainFunctions",D=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=D);const l="bumpFragmentFunctions",I=`#if defined(BUMP)
