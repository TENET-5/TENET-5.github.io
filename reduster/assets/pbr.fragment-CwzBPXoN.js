...
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=Q);const A="pbrBlockAlphaFresnel",ee=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=ee);const m="pbrBlockAnisotropic",ie=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=ie);const I="pbrBlockReflection",ne=`#ifdef REFLECTION
...
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=Se);const b="pbrBlockFinalColorComposition",Ae=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=Ae);const B="pbrBlockImageProcessing",me=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=me);const y="pbrBlockPrePass",Ie=`#if SCENE_MRT_COUNT>0
