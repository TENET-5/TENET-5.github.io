import{X as t}from"./index-J6u3VBh4.js";const e="volumetricLightingBlendVolumePixelShader",n=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;var depthSampler: texture_2d<f32>;uniform invProjection: mat4x4<f32>;uniform outputTextureSize: vec2f;
...
`;t.ShadersStoreWGSL[e]||(t.ShadersStoreWGSL[e]=n);const i={name:e,shader:n};export{i as volumetricLightingBlendVolumePixelShaderWGSL};
