...
(function() {
  ...
  var EVENTS = [
    ...
    { year: 2026, month: 4, title: 'Carney Slashes FINTRAC While Brookfield Routes Pensions Offshore', desc: 'As Carney Government and Brookfield began routing Canadian pension funds through offshore accounts, Carney slashed funding to FINTRAC — the agency responsible for tracking offshore money laundering. PM holds $6.8M in Brookfield options.', link: 'carney-conflicts.html', cat: 'waste', color: '#f59e0b' },
  ];
