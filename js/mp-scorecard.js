...
(function() {
  ...
  function renderScorecard(mp, container) {
    ...
    container.innerHTML =
      '<div class="sc-card">' +
        ...
        '</div>' +
        '<div class="sc-footer">TENET5 MP Scorecard — tenet-5.github.io — Sources: Health Canada, Hansard, Commissioner of Lobbying</div>' +
      '</div>';
  }
  ...
  var shareMsg = function(name, score, grade) {
    return 'My MP ' + name + ' scored ' + grade + ' (' + score + '/100) on the TENET5 MP Scorecard. Check your MP\'s record:';
  };
