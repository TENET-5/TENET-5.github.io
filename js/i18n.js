...
(function() {
    ...
    const newfieRules = [
        ...
        { regex: /\bWhat are you doing\b/gi, replacement: "Whaddya at, b'y" },
        { regex: /\bWhat is going on\b/gi, replacement: "What in the lard jaysus is goin' on" },
        { regex: /\bI have (completed|finished|done)\b/gi, replacement: "I's after $1in'" },
        { regex: /\bI have been\b/gi, replacement: "I been after bein'" },
        { regex: /\bI don't know\b/gi, replacement: "Lord dyin', I got no clue" },
        { regex: /\bI don't care\b/gi, replacement: "I don't give a good goddamn" },
        { regex: /\bcome here\b/gi, replacement: "git over 'ere" },
        { regex: /\bare you serious\b/gi, replacement: "are ye havin' me on" },
        { regex: /\bshut up\b/gi, replacement: "shut yer gob" },
        { regex: /\bget out\b/gi, replacement: "git the hell out" },
        { regex: /\bgo away\b/gi, replacement: "git on wit' ye" },
        { regex: /\bover there\b/gi, replacement: "over d'ere" },
        { regex: /\bright now\b/gi, replacement: "right friggin' now" },
        { regex: /\bI am going to\b/gi, replacement: "I's gonna" },
        { regex: /\bgoing to\b/gi, replacement: "gonna" },
        { regex: /\blook at that\b/gi, replacement: "luh at dat" },
        ...
        { regex: /\bfor god's sake\b/gi, replacement: "fer the love of lard tunderin' jaysus" },
        { regex: /\boh my god\b/gi, replacement: "lard tunderin' jaysus" },
        { regex: /\boh god\b/gi, replacement: "lard dyin'" },
        ...
        { regex: /\bVery\b/g, replacement: "Some shockin'" },
        { regex: /\bvery\b/g, replacement: "some shockin'" },
        { regex: /\breally\b/gi, replacement: "right friggin'" },
        { regex: /\bextremely\b/gi, replacement: "right crooked" },
        { regex: /\bcompletely\b/gi, replacement: "altogether" },

        // ── Nouns & slang ──
        { regex: /\bHello\b/gi, replacement: "Whaddya at" },
        { regex: /\bgoodbye\b/gi, replacement: "long may yer big jib draw" },
        { regex: /\byes\b/gi, replacement: "yeah, b'y" },
        { regex: /\bno\b/g, replacement: "nah, b'y" },
        { regex: /\bfriend\b/gi, replacement: "buddy" },
        { regex: /\bfriends\b/gi, replacement: "crowd" },
        { regex: /\bperson\b/gi, replacement: "livyer" },
        { regex: /\bpeople\b/gi, replacement: "crowd" },
        { regex: /\bboy\b/gi, replacement: "b'y" },
        { regex: /\bman\b/g, replacement: "skipper" },
        { regex: /\bwoman\b/gi, replacement: "missus" },
        { regex: /\bchildren\b/gi, replacement: "youngsters" },
        { regex: /\bchild\b/gi, replacement: "young one" },
        { regex: /\bhouse\b/gi, replacement: "place" },
        { regex: /\bmoney\b/gi, replacement: "dolla" },
        { regex: /\bcar\b/gi, replacement: "machine" },
        { regex: /\bdrunk\b/gi, replacement: "right loaded" },
        { regex: /\bstupid\b/gi, replacement: "stunned as me arse" },
        { regex: /\bidiot\b/gi, replacement: "friggin' gommel" },
        { regex: /\bcrazy\b/gi, replacement: "cracked as a cod" },
        { regex: /\bliar\b/gi, replacement: "lyin' arse" },
        { regex: /\bcorrupt\b/gi, replacement: "crooked as sin" },
        { regex: /\bcorruption\b/gi, replacement: "crookedness" },
        { regex: /\bfraud\b/gi, replacement: "goddamn thievery" },
        { regex: /\bcriminal\b/gi, replacement: "friggin' crook" },
        { regex: /\bpolice\b/gi, replacement: "da constabulary" },
        { regex: /\bgovernment\b/gi, replacement: "da crowd in charge" },
        { regex: /\bpolitician\b/gi, replacement: "bloody politician" },
        { regex: /\bpoliticians\b/gi, replacement: "da bloody politicians" },
        { regex: /\bminister\b/gi, replacement: "bloody minister" },
        { regex: /\binvestigation\b/gi, replacement: "sniff-around" },
        { regex: /\bevidence\b/gi, replacement: "da proof" },
        { regex: /\bwhistleblower\b/gi, replacement: "fella what ratted d'em out" },
        ...
        { regex: /\bmurder\b/gi, replacement: "friggin' murder" },
        { regex: /\bkilled\b/gi, replacement: "right crooshed" },
        { regex: /\bdestroyed\b/gi, replacement: "ruint altogether" },
        { regex: /\bbroken\b/gi, replacement: "busted to bits" },
        ...
        { regex: /\bexcellent\b/gi, replacement: "best kind" },
        ...
        { regex: /\beverything\b/gi, replacement: "every last t'ing" },
        { regex: /\banything\b/gi, replacement: "a single t'ing" },
        ...
        { regex: /\bangry\b/gi, replacement: "right poisoned" },
    ...
    const _newfieExclamations = [
        ", b'y", ", luh", ", wha", ", me son", ", me ducky",
        ", I tells ye", ", lard tunderin'", ", bloody 'ell",
        ", fer chrissakes", ", by da jaysus", ", sure as shit"
    ];
