...
# Transitioned to Google App Passwords for SMTP Auth stabilization
SMTP_SERVER = os.environ.get("TENET_SMTP_SERVER", "smtp.gmail.com")
SMTP_PORT = int(os.environ.get("TENET_SMTP_PORT", 587))
# Google App Password Setup: Enable 2FA on Google Account -> Generate App Password
FROM_EMAIL = os.environ.get("TENET_EMAIL_ACCOUNT", "tenet5.osint@gmail.com")
PASSWORD = os.environ.get("TENET_EMAIL_PASS", "your-16-char-app-password")
SUBJECT = "Urgent: Section 504 Evidence - Mark Carney/Brookfield/MAID Dossier"
